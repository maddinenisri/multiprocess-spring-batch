...
public class MultiLineItemReader implements ItemReader<ContainerVO>, ItemStream {
    ...
    public ContainerVO read() throws Exception {
        ...
        for (Object obj; (obj = this.delegate.read()) != null;) {
            if(obj instanceof FieldSet) {
                FieldSet line = (FieldSet)obj;
                ...
                containerVO = new ContainerVO();
                containerVO.setSimpleVO((SimpleVO)obj);
                Integer seq = sequenceGenerator.getNextSequence(containerVO.getSimpleVO().getKey());
